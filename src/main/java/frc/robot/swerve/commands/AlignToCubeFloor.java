...
public class AlignToCubeFloor extends PIDCommand {
    ...
    private int pipelineIndex = VisionConfig.cubeDetectorPipeline;
     ...
     * @param pipeline
     */
    public AlignToCubeFloor(DoubleSupplier fwdPositiveSupplier, double offset) {
        super(
        ...
        this.setName("AlignToCubeObject");
    }
