...
public class DriveToConeNode extends PIDCommand {
    ...
    private static double verticalSetpoint = -5.35; // neg
    ...
    private final int pipeline = VisionConfig.reflectivePipeline;
    ...
    public DriveToConeNode(double horizontalOffset) {
        super(
                ...
                () -> getVerticalSetpoint(VisionConfig.reflectivePipeline),
