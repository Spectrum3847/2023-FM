...
public class RobotTelemetry extends TelemetrySubsystem {
    ...
    public RobotTelemetry(String name) {
        ...
        tab.addNumber("DefLLVerticalOffset", () -> Robot.vision.defaultVerticalOffset).withPosition(3, 4);
        tab.addNumber("DefLLHorizontalOffset", () -> Robot.vision.defaultHorizontalOffset).withPosition(3, 5);
