...
public final class VisionConfig {
    ...
    public static final int autoReflectivePipeline =
            1; // same as reflective pipeline but with a bounding box
    ...
    public static final int autoConeDetectorPipeline =
            1; // we made them the same for each limelight
