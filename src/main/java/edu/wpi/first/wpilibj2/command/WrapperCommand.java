...
public abstract class WrapperCommand extends Command {
     ...
     * Wrap a command.
     *
     * @param command the command being wrapped. Trying to directly schedule this command or add it
     *     to a composition will throw an exception.
     */
     ...
     * subsystem at the same time. If the command is scheduled as interruptible and another command
     * is scheduled that shares a requirement, the command will be interrupted. Else, the command
     * will not be scheduled. If no subsystems are required, return an empty set.
     *
