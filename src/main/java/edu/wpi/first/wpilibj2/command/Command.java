...
public abstract class Command implements Sendable {
     ...
     * #getInterruptionBehavior()} will be checked and followed. If no subsystems are required,
     * return an empty set.
     *
    ...
    /**
     * Decorates this command with a timeout. If the specified timeout is exceeded before the
     * command finishes normally, the command will be interrupted and un-scheduled.
     *
     * <p>Note: This decorator works by adding this command to a composition. The command the
     * decorator was called on cannot be scheduled independently or be added to a different
     * composition (namely, decorators), unless it is manually cleared from the list of composed
     * commands with {@link CommandScheduler#removeComposedCommand(Command)}. The command
     * composition returned from this method can be further decorated without issue.
     *
     ...
     * running and the condition changes to true, the command will not stop running. The
     * requirements of this command will be kept for the new conditional command.
     *
     * <p>Note: This decorator works by adding this command to a composition. The command the
     * decorator was called on cannot be scheduled independently or be added to a different
     * composition (namely, decorators), unless it is manually cleared from the list of composed
     ...
     * running and the condition changes to false, the command will not stop running. The
     * requirements of this command will be kept for the new conditional command.
     *
     * <p>Note: This decorator works by adding this command to a composition. The command the
     * decorator was called on cannot be scheduled independently or be added to a different
    ...
    /**
     * Decorates this command to have a different {@link InterruptionBehavior interruption
     * behavior}.
     *
