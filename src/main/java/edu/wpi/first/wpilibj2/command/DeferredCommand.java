...
public class DeferredCommand extends Command {
     ...
     * it ends. Useful for lazily creating commands at runtime. The {@link Supplier} will be called
     * each time this command is initialized. The Supplier <i>must</i> create a new Command each
     * call.
     *
