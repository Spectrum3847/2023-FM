...
public class RamseteCommand extends Command {
     ...
     * @param wheelSpeeds A function that supplies the speeds of the left and right sides of the
     *     robot drive.
    ...
    public RamseteCommand(
        ...
        m_rightController =
                requireNonNullParam(rightController, "rightController", "RamseteCommand");
    ...
    public RamseteCommand(
        ...
        m_output =
                requireNonNullParam(
                        outputMetersPerSecond, "outputMetersPerSecond", "RamseteCommand");
